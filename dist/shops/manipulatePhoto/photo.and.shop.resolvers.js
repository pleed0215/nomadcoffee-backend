              ...
              prisma.coffeeShop
                .update({
                  ...
                  data: __assign(
                    ...
                    uploaded_1.length > 0 && {
                      photos: {
                        create: uploaded_1.map(function (url) {
                          return { url: url };
                        }),
                      },
                    }
        ...
        case 8:
          ...
          if (e_1.hasOwnProperty("uploaded")) {
            ...
            if (e_1.uploaded && e_1.uploaded.length > 0) {
              e_1.uploaded.forEach(function (photo) {
                return s3_1.removeFile(photo);
              });
            }
            return [
              2 /*return*/,
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            prisma.coffeeShopPhoto.findUnique({
              where: { id: photoId },
              rejectOnNotFound: true,
            }),
          ];
        case 1:
          ...
          if (photo.shopId !== id) {
            throw new Error(
              "Permission Error: Cannot remove photo, because of photo not belongs to CoffeeShop:" +
                id
            );
          }
          return [
